...
<div>
    ...
    <a href="${pageContext.request.contextPath }/client/old/listcart.jsp.jsp" target="body">查看购物车</a>
    <a href="${pageContext.request.contextPath }/client/ClientListOrderServlet?userid=${user.id}"
       target="body"">查看订单</a>
</div>
